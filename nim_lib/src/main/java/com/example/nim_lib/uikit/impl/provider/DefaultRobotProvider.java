package com.example.nim_lib.uikit.impl.provider;

import com.example.nim_lib.uikit.api.model.SimpleCallback;
import com.example.nim_lib.uikit.api.model.robot.RobotInfoProvider;
import com.example.nim_lib.uikit.impl.cache.RobotInfoCache;
