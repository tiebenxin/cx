...
import com.example.nim_lib.notification.AVChatNotification;
import com.example.nim_lib.receiver.PhoneCallStateObserver;
import com.example.nim_lib.ui.AVChatAudioUI;
import com.example.nim_lib.ui.AVChatVideoUI;
...
//    private FaceU faceU;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        root = LayoutInflater.from(this).inflate(R.layout.activity_call_wait, null);
        setContentView(root);
    ...
    private void parseIntent() {
        ...
        System.out.println(AVChatActivity.class.getSimpleName() + "--callType=" + state);
    }
