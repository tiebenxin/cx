 ...
 * @author Liszt
 * @date 2020/5/25
 * Description 冻结账号-手机验证界面
 */
public class FreezeAccountIdentifyActivity extends AppActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ui = DataBindingUtil.setContentView(this, R.layout.activity_freeze_identify);
    ...
    private void initCountDownUtil() {
        ...
        if (TextUtils.isEmpty(phone)) {
            ToastUtil.show(FreezeAccountIdentifyActivity.this, "请填写手机号码");
            return;
        }
