...
public class OrderInfoUtil2_0 {
	 ...
	 * @return
	 */
	public static Map<String, String> buildRedParamMap(String app_id,String amout,String msg, boolean rsa2) {
		Map<String, String> keyValues = new HashMap<String, String>();
		...
		keyValues.put("timestamp", TimeToString.YYYY_MM_DD_HH_MM_SS(new Date().getTime()));
