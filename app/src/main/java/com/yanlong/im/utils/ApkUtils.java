...
public class ApkUtils {
    ...
    //启动外部app
    public static void startSchemeApp(Context context, String packageName, String startActivity, String apkDownloadUrl, String schemeUrl) {
...
//            intent.putExtras(bundle);
    ...
    public static void startSchemeApp(Context context, String appId, String schemeUrl) {
        if (isApkInstalled(context, appId)) {
            if (StringUtil.isNotNull(schemeUrl)) {
                Intent intent = new Intent(Intent.ACTION_VIEW);
                intent.setData(Uri.parse(schemeUrl));
                context.startActivity(intent);
