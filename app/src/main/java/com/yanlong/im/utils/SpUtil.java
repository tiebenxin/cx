...
public class SpUtil {
    ...
    public static SpUtil getSpUtil(String fileKey, int mode) {
        if (spUtil == null) {
            ...
            sp = MainApplication.getInstance().getSharedPreferences(fileKey, mode);
        }
        return spUtil;
    }
    ...
    public static SpUtil getSpUtil() {
        if (spUtil == null) {
            ...
            sp = MainApplication.getInstance().getSharedPreferences(CONFIG_PREFERENCES, Context.MODE_PRIVATE);
        }
        return spUtil;
    }
