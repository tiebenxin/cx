...
public final class MsgBean {
    ...
    public  static final class ChatMessage extends
        ...
        public static final class Builder extends
            ...
            // Construct using MsgTestBean.ChatMessage.newBuilder()
            private Builder() {
    ...
    public  static final class ImageMessage extends
        ...
        public static final class Builder extends
            ...
            // Construct using MsgTestBean.ImageMessage.newBuilder()
            private Builder() {
                maybeForceBuilderInitialization();
            }
    ...
    public  static final class RedEnvelopeMessage extends
        ...
        public static final class Builder extends
            ...
            // Construct using MsgTestBean.RedEnvelopeMessage.newBuilder()
            private Builder() {
                maybeForceBuilderInitialization();
            }
    ...
    public  static final class ReceiveRedEnvelopeMessage extends
        ...
        public static final class Builder extends
            ...
            // Construct using MsgTestBean.ReceiveRedEnvelopeMessage.newBuilder()
            private Builder() {
                maybeForceBuilderInitialization();
            }
    ...
    public  static final class TransferMessage extends
        ...
        public static final class Builder extends
            ...
            // Construct using MsgTestBean.TransferMessage.newBuilder()
            private Builder() {
                maybeForceBuilderInitialization();
            }
    ...
    public  static final class StampMessage extends
        ...
        public static final class Builder extends
            ...
            // Construct using MsgTestBean.StampMessage.newBuilder()
            private Builder() {
                maybeForceBuilderInitialization();
            }
    ...
    public  static final class BusinessCardMessage extends
        ...
        public static final class Builder extends
            ...
            // Construct using MsgTestBean.BusinessCardMessage.newBuilder()
            private Builder() {
                maybeForceBuilderInitialization();
            }
    ...
    public  static final class RequestFriendMessage extends
        ...
        public static final class Builder extends
            ...
            // Construct using MsgTestBean.RequestFriendMessage.newBuilder()
            private Builder() {
                maybeForceBuilderInitialization();
            }
    ...
    public  static final class AcceptBeFriendsMessage extends
        ...
        public static final class Builder extends
            ...
            // Construct using MsgTestBean.AcceptBeFriendsMessage.newBuilder()
            private Builder() {
                maybeForceBuilderInitialization();
            }
    ...
    public  static final class AckMessage extends
        ...
        public static final class Builder extends
            ...
            // Construct using MsgTestBean.AckMessage.newBuilder()
            private Builder() {
                maybeForceBuilderInitialization();
            }
    ...
    public  static final class AuthRequestMessage extends
        ...
        public static final class Builder extends
            ...
            // Construct using MsgTestBean.AuthRequestMessage.newBuilder()
            private Builder() {
                maybeForceBuilderInitialization();
            }
    ...
    public  static final class AuthResponseMessage extends
        ...
        public static final class Builder extends
            ...
            // Construct using MsgTestBean.AuthResponseMessage.newBuilder()
            private Builder() {
                maybeForceBuilderInitialization();
            }
    ...
    public interface UniversalMessageOrBuilder extends
         ...
         * <code>.AckMessage ack = 10112;</code>
         */
        MsgBean.AckMessageOrBuilder getAckOrBuilder();
    ...
    public  static final class UniversalMessage extends
                    ...
                    switch (tag) {
                        ...
                        case 80898: {
                            ...
                            if (realMsgCase_ == 10112) {
                                subBuilder = ((MsgBean.AckMessage) realMsg_).toBuilder();
                            }
                            realMsg_ =
                                    input.readMessage(MsgBean.AckMessage.parser(), extensionRegistry);
                            if (subBuilder != null) {
                                subBuilder.mergeFrom((MsgBean.AckMessage) realMsg_);
                                realMsg_ = subBuilder.buildPartial();
                            }
                            realMsgCase_ = 10112;
                            break;
         ...
         * <code>.AckMessage ack = 10112;</code>
         */
        public MsgBean.AckMessage getAck() {
            if (realMsgCase_ == 10112) {
                return (MsgBean.AckMessage) realMsg_;
            }
            return MsgBean.AckMessage.getDefaultInstance();
        }
        /**
         * <code>.AckMessage ack = 10112;</code>
         */
        public MsgBean.AckMessageOrBuilder getAckOrBuilder() {
            if (realMsgCase_ == 10112) {
                return (MsgBean.AckMessage) realMsg_;
            }
            return MsgBean.AckMessage.getDefaultInstance();
        ...
        public int getSerializedSize() {
            ...
            if (realMsgCase_ == 10112) {
                size += com.google.protobuf.CodedOutputStream
                        .computeMessageSize(10112, (MsgBean.AckMessage) realMsg_);
            }
            memoizedSize = size;
            return size;
        }
        ...
        public static final class Builder extends
            ...
            // Construct using MsgTestBean.UniversalMessage.newBuilder()
            private Builder() {
                maybeForceBuilderInitialization();
            }
            ...
            public MsgBean.UniversalMessage buildPartial() {
                ...
                if (realMsgCase_ == 10112) {
                    if (ackBuilder_ == null) {
                        ...
                        result.realMsg_ = ackBuilder_.build();
                    }
                }
             ...
             * <code>.AckMessage ack = 10112;</code>
             */
            public Builder setAck(MsgBean.AckMessage value) {
                if (ackBuilder_ == null) {
                    if (value == null) {
                        throw new NullPointerException();
                    }
            ...
            public Builder setAck(
                    MsgBean.AckMessage.Builder builderForValue) {
                if (ackBuilder_ == null) {
                    realMsg_ = builderForValue.build();
                    onChanged();
                } else {
             ...
             * <code>.AckMessage ack = 10112;</code>
             */
            public Builder mergeAck(MsgBean.AckMessage value) {
                if (ackBuilder_ == null) {
                    if (realMsgCase_ == 10112 &&
                            realMsg_ != MsgBean.AckMessage.getDefaultInstance()) {
                        realMsg_ = MsgBean.AckMessage.newBuilder((MsgBean.AckMessage) realMsg_)
                                .mergeFrom(value).buildPartial();
                    } else {
                        realMsg_ = value;
                    }
             ...
             * <code>.AckMessage ack = 10112;</code>
             */
            public MsgBean.AckMessage.Builder getAckBuilder() {
             ...
             */
            public MsgBean.AckMessageOrBuilder getAckOrBuilder() {
                if ((realMsgCase_ == 10112) && (ackBuilder_ != null)) {
             ...
             */
            private com.google.protobuf.SingleFieldBuilderV3<
                    MsgBean.AckMessage, MsgBean.AckMessage.Builder, MsgBean.AckMessageOrBuilder>
            getAckFieldBuilder() {
                if (ackBuilder_ == null) {
                    if (!(realMsgCase_ == 10112)) {
                        realMsg_ = MsgBean.AckMessage.getDefaultInstance();
    ...
    static {
        java.lang.String[] descriptorData = {
                ...
                "chat\030\365N \001(\0132\014.ChatMessageH\001\022\037\n\005image\030\366N " +
                        "\001(\0132\r.ImageMessageH\001\022,\n\014red_envelope\030\367N " +
                        "\001(\0132\023.RedEnvelopeMessageH\001\022;\n\024receive_re" +
                        "d_envelope\030\370N \001(\0132\032.ReceiveRedEnvelopeMe" +
                        "ssageH\001\022%\n\010transfer\030\371N \001(\0132\020.TransferMes" +
