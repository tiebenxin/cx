...
public class FaceView extends RelativeLayout {
	...
	/** 动态表情ID列表 */
	private static int[] animo_emojiIds = { R.mipmap.animation_emotion_000, };
	/** 动态表情名称 */
	private static String[] animo_emojiNames = { "animation_emotion_000", "animation_emotion_001", "animation_emotion_002", "animation_emotion_003",
			"animation_emotion_004", "animation_emotion_005", "animation_emotion_006", "animation_emotion_007", "animation_emotion_008",
			"animation_emotion_009", "animation_emotion_010", "animation_emotion_011", "animation_emotion_012", "animation_emotion_013",
			"animation_emotion_014", "animation_emotion_015", "animation_emotion_016", "animation_emotion_017", "animation_emotion_018",
			"animation_emotion_019", };
	/** 自定义表情 */
	...
	public void initFaceList(int type_emoji) {
		...
		case face_emoji_tab:
			...
			// faceType = FaceAdapter.FACE_TYPE_EMOJI;
			break;
		case face_animo_tab:
			pagerSize = 8;
			for (int i = 0; i < animo_emojiIds.length; i++) {
			...
			// faceType = FaceAdapter.FACE_TYPE_ANIMO;
			break;
