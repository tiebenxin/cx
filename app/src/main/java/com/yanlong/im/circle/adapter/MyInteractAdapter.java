...
public class MyInteractAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
            ...
            if (dataList != null && dataList.size() > 0) {
                if (dataList.get(position) != null) {
                    ...
                    holder.layoutItem.setOnClickListener(v -> {
                       //跳详情
                        httpQueryById(bean.getMomentId(),bean.getMomentUid());
                    });
                    //互动内容显示
                    ...
                    }else if(bean.getInteractType()==2 || bean.getInteractType()==5){//评论、删除评论
                    ...
                    //内容->普通黑体
                    start = end;
                    if(bean.getInteractType()==2 || bean.getInteractType()==5){
     ...
     */
    public void httpQueryById(Long momentId, Long momentUid) {
