 ...
 * @updateAuthor
 * @updateDate
 * @description 广场两个fragment独用
 * @copyright copyright(c)2020 ChangSha YouMeng Technology Co., Ltd. Inc. All rights reserved.
 */
public abstract class BaseCircleFragment<P extends BasePresenter, SV extends ViewDataBinding> extends Fragment implements IBaseView {
