                ...
                if (notice.getMsgType() == MsgNotice.MSG_TYPE_DEFAULT
                    ...
                    if (notice.getMsgType() == ChatEnum.ENoticeType.SYS_ENVELOPE_RECEIVED || notice.getMsgType() == ChatEnum.ENoticeType.RECEIVE_SYS_ENVELOPE
                        ...
                        if(notice.getMsgType() == ChatEnum.ENoticeType.INVITE_VERIFICATION){
                            tv_content.setText(new HtmlTransitonUtils().getSpannableString(mContext, message.getMsgNotice().getNote(), message.getMsgNotice().getMsgType(),0,message.getMsgNotice().getRemark()));
                        }else {
