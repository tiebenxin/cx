...
public class NewPullRefreshLayout extends ViewGroup {
...
//    public static final int STYLE_SMARTISAN = 4;
    ...
    private net.cb.cb.library.view.RefreshDrawable mRefreshDrawable;
    ...
    public NewPullRefreshLayout(Context context) {
        this(context, null);
    }

    public NewPullRefreshLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
