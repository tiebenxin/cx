...
public class ScreenShotListenManager {
    ...
    private ScreenShotListenManager(Context context) {
        ...
        if (sScreenRealSize == null) {
            ...
            if (sScreenRealSize != null) {
                LogUtil.getLog().e("Screen Real Size: " + sScreenRealSize.x + " * " + sScreenRealSize.y);
            } else {
                LogUtil.getLog().e("Get screen real size failed.");
            }
        }
    }
    ...
    private void handleMediaContentChange(Uri contentUri) {
        ...
        try {
            ...
            if (cursor == null) {
                LogUtil.getLog().e("Deviant logic.");
                return;
            }
            if (!cursor.moveToFirst()) {
                LogUtil.getLog().e("Cursor no data.");
                return;
            }
    ...
    private void handleMediaRowData(String data, long dateTaken, int width, int height) {
        ...
        if (checkScreenShot(data, dateTaken, width, height)) {
            ...
            LogUtil.getLog().e("Media content changed, but not screenshot: path = " + data
