 ...
 * @Date：2020/7/7
 * @by zjy
 * @备注： 复用修改了com.mcxtzhang.swipemenulib的SwipeMenuLayout，普通侧滑用第三方的SwipeMenuLayout即可
 */
 ...
 * Date: 16/04/24
 */
public class NewSwipeMenuLayout extends ViewGroup {
    ...
    //存储的是当前正在展开的View
    private static NewSwipeMenuLayout mViewCache;
    ...
    private SwipeLayoutOpenCloseListener openCloseListener;


    public NewSwipeMenuLayout(Context context) {
        this(context, null);
    }

    public NewSwipeMenuLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public NewSwipeMenuLayout(Context context, AttributeSet attrs, int defStyleAttr) {
     ...
     * @param ios
     */
    public NewSwipeMenuLayout setIos(boolean ios) {
        isIos = ios;
        return this;
    }
     ...
     * @return
     */
    public NewSwipeMenuLayout setLeftSwipe(boolean leftSwipe) {
     ...
     * @return
     */
    public static NewSwipeMenuLayout getViewCache() {
        return mViewCache;
    }

    public void setOpenOrCloseListenr(SwipeLayoutOpenCloseListener listenr){
        openCloseListener = listenr;
    }
...
/*                    if (!mScroller.isFinished()) {
    ...
    public void smoothExpand() {
        ...
        invalidate();*/
        //展开就加入ViewCache：
        mViewCache = NewSwipeMenuLayout.this;
        ...
        openCloseListener.changeStatus(true);
    }
...
/*        mScroller.startScroll(getScrollX(), 0, -getScrollX(), 0);
        ...
        openCloseListener.changeStatus(false);
    }
