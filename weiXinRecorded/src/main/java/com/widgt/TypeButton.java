...
public class TypeButton extends View {
    ...
    public TypeButton(Context context, AttributeSet attrs) {
        super(context, attrs);
        TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.TypeButton);
        button_size = typedArray.getDimensionPixelSize(R.styleable.TypeButton_bt_size, 40);
        button_type = typedArray.getInteger(R.styleable.TypeButton_button_type, 0);
        typedArray.recycle();
        init(button_type, button_size);
    }
