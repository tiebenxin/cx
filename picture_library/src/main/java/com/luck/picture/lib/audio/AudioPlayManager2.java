...
//        }
    ...
    private void setScreenOff() {
        if (this._wakeLock == null) {
            if (Build.VERSION.SDK_INT >= 21) {
                this._wakeLock = this._powerManager.newWakeLock(32, "Education:AudioPlayManagerTag");
            } else {
    ...
    public void startPlay(Context context, Uri audioUri, int position, IAudioPlayListener playListener) {
        if (context != null && audioUri != null) {
            this.context = context;
            if (this._playListener != null && this._playingUri != null) {
                this._playListener.onStop(this._playingUri);
            ...
            try {
                ...
                this._mediaPlayer.setAudioStreamType(3);
                this._mediaPlayer.prepare();
                this._mediaPlayer.seekTo(position);
                this._mediaPlayer.start();
                //this._mediaPlayer.seekTo();
                if (this._playListener != null) {
                    this._playListener.onStart(this._playingUri);
