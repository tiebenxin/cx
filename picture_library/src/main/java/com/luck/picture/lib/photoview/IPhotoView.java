...
public interface IPhotoView {
     ...
     * @param listener - Listener to be registered.
     */
    void setOnMatrixChangeListener(PhotoViewAttacher2.OnMatrixChangedListener listener);
     ...
     * @param listener - Listener to be registered.
     */
    void setOnPhotoTapListener(PhotoViewAttacher2.OnPhotoTapListener listener);
     ...
     * @param listener - Listener to be registered.
     */
    void setOnViewTapListener(PhotoViewAttacher2.OnViewTapListener listener);
    ...
    /**
     * Allows to change zoom transition speed, default value is 200 (PhotoViewAttacher2.DEFAULT_ZOOM_DURATION).
    ...
    /**
     * Will return instance of IPhotoView (eg. PhotoViewAttacher2), can be used to provide better
     * integration
     *
     ...
     * default, you can just pass in "null" or public field of PhotoViewAttacher2.defaultOnDoubleTapListener
     *
     ...
     */
    void setOnScaleChangeListener(PhotoViewAttacher2.OnScaleChangeListener onScaleChangeListener);
     ...
     */
    void setOnSingleFlingListener(PhotoViewAttacher2.OnSingleFlingListener onSingleFlingListener);
