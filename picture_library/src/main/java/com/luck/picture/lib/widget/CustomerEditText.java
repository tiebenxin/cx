...
import com.luck.picture.lib.utils.edit.KeyCodeDeleteHelper;
import com.luck.picture.lib.utils.edit.NoCopySpanEditableFactory;
import com.luck.picture.lib.utils.edit.SpanFactory;
import com.luck.picture.lib.utils.edit.SpannableEmoj;
import com.luck.picture.lib.utils.edit.SpannableUser;
import com.luck.picture.lib.utils.edit.span.RemoveOnDirtySpan;
import com.luck.picture.lib.utils.edit.watcher.DirtySpanWatcher;
...
public class CustomerEditText extends AppCompatEditText {
     ...
     * 添加Emoj表情,一个表情
     */
    public void addEmojSpan(Context context, String emojText) {
        try {
            int start = getSelectionStart();
            SpannableStringBuilder sb = new SpannableStringBuilder(getText() == null ? "" : getText());
            SpannableEmoj emoj = new SpannableEmoj(context, emojText);
     ...
     */
    public void showDraftContent(Context context, String text) throws SecurityException,
...
//            sb.insert(start, spannable);
    ...
    private void insert(Context context, String text) throws SecurityException,
            NumberFormatException, IllegalArgumentException {
