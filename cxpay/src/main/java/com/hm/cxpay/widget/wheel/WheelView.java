...
public class WheelView extends View implements IWheelViewSetting {
    ...
    public void initAttr(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        float defaultTextSize = TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 16, getResources().getDisplayMetrics());
        textColor = a.getColor(R.styleable.WheelView_wheelTextColor, Color.parseColor("#0f0f0f"));
